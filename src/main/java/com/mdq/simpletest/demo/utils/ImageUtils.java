...
//        // 4-彩色转黑白：
  //      ImageUtils.gray("e:/abc.jpg", "e:/abc_gray.jpg");//测试OK
        ...
        // 5-给图片添加文字水印：
        // 方法一：
        //ImageUtils.pressText("我是水印文字","C:\\Users\\madaqiang\\Pictures\\FLAMING MOUNTAIN.JPG","d:/abc_pressText.jpg","宋体",Font.BOLD,Color.white,80, 0, 0, 0.5f);//测试OK
        // 方法二：
        //ImageUtils.pressText2("我也是水印文字", "e:/abc.jpg","e:/abc_pressText2.jpg", "黑体", 36, Color.white, 80, 0, 0, 0.5f);//测试OK

        // 6-给图片添加图片水印：
        ImageUtils.pressImage("D:\\upload1.jpg", "D:\\upload.jpg","d:/abc_pressImage.jpg", 0, 0, 0.5f);//测试OK
    }
