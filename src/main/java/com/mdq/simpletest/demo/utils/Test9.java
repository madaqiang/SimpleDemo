...
public class Test9 {
    public final  static String[] testArray = new String[];
    public final  static List<String> testList = new ArrayList<>();

//    public static void test1(List<String> testList){
//        testList.add("c");
//    }
...
//        System.out.println("数组内容改变后a的地址:"+a);
    ...
    public  static void testBoolean(Boolean flag){
        flag =true;
